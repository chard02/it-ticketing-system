                        ...
                        <div class="form-group">
                            ...
                            <select name="unit_id" class="form-select @error('unit_id') is-invalid @enderror">
                                ...
                                @foreach ($unit as $item)
                                    <option value="{{ $item->id }}" @selected(old('unit_id', $jabatan->unit_id) == $item->id)>
                                        {{ $item->nama_unit }}
                                    </option>
                                @endforeach
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <select name="status" class="form-select @error('status') is-invalid @enderror">
                                ...
                                <option value="AKTIF" @selected(old('status', $jabatan->status) === 'AKTIF')>
                                    AKTIF
                                </option>

                                <option value="TIDAK_AKTIF" @selected(old('status', $jabatan->status) === 'TIDAK_AKTIF')>
                                    TIDAK AKTIF
                                </option>
